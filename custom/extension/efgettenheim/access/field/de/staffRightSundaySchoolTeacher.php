<?php
   ...
   * @category Extension
   */
  class staffRightSundaySchoolTeacher extends \BB\access\field {
  
    /**
     * @var string $fieldID
     */
    protected $fieldID = 'staffRightSundaySchoolTeacher';
    /**
     * @var string
     */
     ...
     * @var string $name
     */
    protected $name = 'Sonntagsschulbetreuer';
    /**
